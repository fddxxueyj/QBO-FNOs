...
Structure:
1. Physical understanding for 1D-QBO model, mainly concerning critical layer;
2. Parameter sensitivity analysis in 1D-QBO model, including the thermal dissipation rate of waves $\alpha$ and the Rayleigh damping of the mean flow;
