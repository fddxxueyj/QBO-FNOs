...
3. `param_kappa.ipynb` and `param_alpha.ipynb`: Parameter sensitivity analysis in 1D-QBO model, including the dissipation rate of waves $\alpha$ and the diffusion of the mean flow $\kappa$;
